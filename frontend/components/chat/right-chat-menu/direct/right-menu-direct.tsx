...
// Make this chanegable when the user uses the normal conversation or when using channels, or when not using both

const RightMenuDirect = () => {
    return (
...
export default RightMenuDirect;